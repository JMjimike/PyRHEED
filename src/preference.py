...
class Window(QtCore.QObject):
    ...
    def __init__(self):
        ...
        self.defaultLineValueList = [
            ["0", "0", "20", "0", "5", "60", "0.4", "100", "5", "20", "10", "0", "10"],
            [
                "361.13",
                "20",
                "0",
    ...
    def main(self):
        ...
        self.DefaultSettings_DialogGrid = QtWidgets.QGridLayout(
            self.DefaultSettings_Dialog
        )
        ...
        buttonBox.findChildren(QtWidgets.QPushButton)[2].clicked.connect(
            self.DefaultSettings_Dialog.reject
        )
        ...
        self.DefaultSettings_Dialog.setWindowModality(
    ...
    def save(self, lineValueList):
        ...
        Dic = {
            "windowDefault": {
                key: value for (key, value) in zip(windowKeys, lineValueList[0])
            },
            "propertiesDefault": {
                key: value for (key, value) in zip(propertiesKeys, lineValueList[1])
            },
            "canvasDefault": {
                key: value for (key, value) in zip(canvasKeys, lineValueList[2])
            },
            "chartDefault": {
                key: value for (key, value) in zip(chartKeys, lineValueList[3])
            },
        }
    ...
    def refresh_tab(self, config):
        ...
        windowMode = [
            ...
            (
                "Integral Half Width Slider Scale",
                windowDefault["widthsliderscale"],
                7,
                0,
                1,
            ),
            ...
            (
                "Tilt Angle Slider Scale",
                windowDefault["tiltanglesliderscale"],
                12,
                0,
                1,
            ),
        ...
        propertiesMode = [
            (
                "Sensitivity (pixel/sqrt[keV])",
                propertiesDefault["sensitivity"],
                0,
                0,
                3,
            ),
            ...
            (
                "Scale Bar Length (\u212B\u207B\u00B9)",
                propertiesDefault["scalebarlength"],
                3,
                0,
                3,
            ),
            ...
            (
                "Brightness (Minimum,Default,Maximum)",
                propertiesDefault["brightnessminimum"],
                4,
                0,
                1,
            ),
            ...
            (
                "Black Level (Minimum,Default,Maximum)",
                propertiesDefault["blacklevelminimum"],
                5,
                0,
                1,
            ),
            ...
            (
                "Half Width (\u212B\u207B\u00B9) (Minimum,Default,Maximum)",
                propertiesDefault["widthminimum"],
                6,
                0,
                1,
            ),
            ...
            (
                "Slider Scales (Half Width,Radius,Tilt Angle)",
                propertiesDefault["widthsliderscale"],
                10,
                0,
                1,
            ),
            ...
            (
                "Chi Range (\u00B0) (Minimum,Default,Maximum)",
                propertiesDefault["chirangeminimum"],
                7,
                0,
                1,
            ),
            ...
            (
                "Radius (\u212B\u207B\u00B9) (Minimum,Default,Maximum)",
                propertiesDefault["radiusminimum"],
                8,
                0,
                1,
            ),
            ...
            (
                "Tilt Angle (\u00B0) (Minimum,Default,Maximum)",
                propertiesDefault["tiltangleminimum"],
                9,
                0,
                1,
            ),
        ...
        canvasMode = [
            ("Integral Half Width", canvasDefault["widthinangstrom"], 0, 0, 1),
        ...
        PageMode = [
            (windowGrid, windowMode),
            (propertiesGrid, propertiesMode),
            (canvasGrid, canvasMode),
        ]
        for grid, mode in PageMode:
            for label, value, row, col, span in mode:
                grid.addWidget(QtWidgets.QLabel(label), row, 2 * col, 1, 1)
                grid.addWidget(
                    QtWidgets.QLineEdit(value), row, 2 * col + 1, 1, 2 * span - 1
                )
    ...
    def accept(self):
        windowValueList = [
            item.text() for item in self.window.findChildren(QtWidgets.QLineEdit)
        ]
        propertiesValueList = [
            item.text() for item in self.properties.findChildren(QtWidgets.QLineEdit)
        ]
        canvasValueList = [
            item.text() for item in self.canvas.findChildren(QtWidgets.QLineEdit)
        ]
        chartValueList = [
            item.currentData() for item in self.chart.findChildren(QtWidgets.QComboBox)
        ]
        lineValueList = [
            windowValueList,
            propertiesValueList,
