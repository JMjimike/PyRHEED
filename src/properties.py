...
class Properties(QtWidgets.QWidget):
    ...
    def refresh(self, config):
        ...
        self.integralHalfWidthSlider.setMinimum(
            self.widthMinimum * self.widthSliderScale
        )
        self.integralHalfWidthSlider.setMaximum(
            self.widthMaximum * self.widthSliderScale
        )
        self.integralHalfWidthSlider.setValue(
            int(self.integralHalfWidth * self.widthSliderScale)
        )
        ...
        self.tiltAngleSlider.setMinimum(
            self.tiltAngleMinimum * self.tiltAngleSliderScale
        )
        self.tiltAngleSlider.setMaximum(
            self.tiltAngleMaximum * self.tiltAngleSliderScale
        )
    ...
    def init_UI(self):
        ...
        self.labelButton.setSizePolicy(
        ...
        self.brightnessSlider.setMaximum(self.brightnessMaximum)
        self.brightnessSlider.setValue(self.brightness)
        self.blackLevelLabel = QtWidgets.QLabel(
            "Black Level ({})".format(self.blackLevel)
        )
        ...
        self.applyButton2.setSizePolicy(
            QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed
        )
        self.resetButton2.setSizePolicy(
            QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed
        )
        ...
        self.integralHalfWidthLabel = QtWidgets.QLabel(
            "Integral Half Width ({:3.2f} \u212B\u207B\u00B9)".format(
                self.integralHalfWidth
            )
        )
        self.integralHalfWidthSlider = QtWidgets.QSlider(
        ...
        self.chiRangeLabel = QtWidgets.QLabel(
            "Chi Range ({}\u00B0)".format(self.chiRange)
        )
        self.chiRangeSlider = QtWidgets.QSlider(QtCore.Qt.Orientation.Horizontal)
        self.chiRangeSlider.setMinimum(self.chiRangeMinimum)
        self.chiRangeSlider.setMaximum(self.chiRangeMaximum)
        self.chiRangeSlider.setValue(self.chiRange)
        self.radiusLabel = QtWidgets.QLabel(
            "Radius ({:3.2f} \u212B\u207B\u00B9)".format(self.radius)
        )
        self.radiusSlider = QtWidgets.QSlider(QtCore.Qt.Orientation.Horizontal)
        self.radiusSlider.setMinimum(self.radiusMinimum * self.radiusSliderScale)
        self.radiusSlider.setMaximum(self.radiusMaximum * self.radiusSliderScale)
        self.radiusSlider.setValue(self.radius * self.radiusSliderScale)
        self.tiltAngleLabel = QtWidgets.QLabel(
            "Tilt Angle ({:2.1f}\u00B0)".format(self.tiltAngle)
        )
        ...
        self.applyButton3.setSizePolicy(
            QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed
        )
        self.resetButton3.setSizePolicy(
            QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed
        )
        ...
        self.chartFontSizeLabel = QtWidgets.QLabel(
            "Adjust Chart Font Size ({})".format(12)
        )
        ...
        self.canvasFontSizeLabel = QtWidgets.QLabel(
            "Adjust Canvas Font Size ({})".format(50)
        )
    ...
    def refresh_chart_font_size(self):
        self.chartFontSizeLabel.setText(
            "Adjust Chart Font Size ({})".format(self.chartFontSizeSlider.value())
        )
        self.CHART_FONTS_CHANGED.emit(
            self.fontList.currentFont().family(), self.chartFontSizeSlider.value()
        )

    def refresh_canvas_font_size(self):
        self.canvasFontSizeLabel.setText(
            "Adjust Canvas Font Size ({})".format(self.canvasFontSizeSlider.value())
        )
        self.CANVAS_FONTS_CHANGED.emit(
            self.fontList.currentFont().family(), self.canvasFontSizeSlider.value()
        )
