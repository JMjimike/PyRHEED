                ...
                result[0].append(
                    np.around(
                        np.sqrt(
                            d1**2
                            + d2**2
                            + 2 * d1 * d2 * np.cos(theta / 180 * np.pi)
                        ),
                        5,
                    )
                )
    ...
    def plot_prob_1d(self, lc_a, lc_b, prob_list):
        ...
        for p in prob_list:
            ...
            ax.scatter(
                distribution[0],
                distribution[1],
                label="p=" + str(p) + ", E(d)=" + str(np.around(d_exp, 3)),
            )
        ax.legend()
        ...
        ax.set_xticklabels(
            np.around(ax.get_xticks(), 4), fontsize=fontsize, fontname=fontname
        )
        ax.set_yticklabels(
            np.around(ax.get_yticks(), 4), fontsize=fontsize, fontname=fontname
        )
        plt.tight_layout()
        plt.show()
    ...
    def plot_prob_1d_and_2d(self, lc_a, lc_b, prob_list, input_path):
        for p in prob_list:
            ...
            ax.scatter(
                distribution[0],
                distribution[1],
                label="1D: p=" + str(p) + ", E(d)=" + str(np.around(d_exp, 3)),
            )
...
if __name__ == "__main__":
    ...
    input_list = [
        "C:/Dev/PyRHEED/source/RHEED scenario 02212021/0.001-70.0nm/0.001.txt",
        "C:/Dev/PyRHEED/source/RHEED scenario 02212021/0.002-70.0nm/0.002.txt",
        "C:/Dev/PyRHEED/source/RHEED scenario 02212021/0.004-70.0nm/0.004.txt",
        "C:/Dev/PyRHEED/source/RHEED scenario 02212021/0.008-70.0nm/0.008.txt",
        "C:/Dev/PyRHEED/source/RHEED scenario 02212021/0.016-70.0nm/0.016.txt",
        "C:/Dev/PyRHEED/source/RHEED scenario 02212021/0.032-70.0nm/0.032.txt",
        "C:/Dev/PyRHEED/source/RHEED scenario 02212021/0.064-70.0nm/0.064.txt",
        "C:/Dev/PyRHEED/source/RHEED scenario 02212021/0.128-70.0nm/0.128.txt",
    ]
